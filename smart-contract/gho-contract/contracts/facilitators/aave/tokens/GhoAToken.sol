    ...
    IGhoAToken
{
    ...
    constructor(
        ...
        ScaledBalanceTokenBase(pool, "GHO_ATOKEN_IMPL", "GHO_ATOKEN_IMPL", 0)
        EIP712Base()
    {
    ...
    function handleRepayment(
        ...
        uint256 balanceFromInterest = _ghoVariableDebtToken
            .getBalanceFromInterest(onBehalfOf);
