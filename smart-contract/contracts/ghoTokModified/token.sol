...
import {IGhoToken} from "../../gho-contract/contracts/gho/interfaces/IGhoToken.sol";

/**
 * @title GHO Token
 * @author Aave
 */
contract GhoToken is ERC20, IGhoToken, AccessControl {
    ...
    bytes32 public constant FACILITATOR_MANAGER_ROLE =
